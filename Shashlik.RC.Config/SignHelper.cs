...
namespace Jinkong.RC.Config
{
    ...
    public class SignHelper
    {
        ...
        public string BuildSign(IDictionary<string, string> ps)
        {
            ...
            list = list.Select(r => new KeyValuePair<string, string>(r.Key.Trim().ToLower(), r.Value))
                .OrderBy(r => r.Key);
        ...
        public bool IsValidSign(IEnumerable<KeyValuePair<string, object>> ps)
        {
            ...
            var list = ps.Select(r => new KeyValuePair<string, string>(r.Key.Trim().ToLower(), r.Value?.ToString()))
