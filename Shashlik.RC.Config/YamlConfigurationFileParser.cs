// Copyright (c) andrewlock/NetEscapades.Configuration
// https://github.com/andrewlock/NetEscapades.Configuration
// copy from https://github.com/andrewlock/NetEscapades.Configuration/blob/1876f13a16d8d59b6bca17342e49af3ceb6a00f6/src/NetEscapades.Configuration.Yaml/YamlConfigurationFileParser.cs    
...
namespace NetEscapades.Configuration.Yaml
{
    internal class YamlConfigurationFileParser
    {
        ...
        private void VisitYamlScalarNode(string context, YamlScalarNode yamlValue)
        {
            ...
            {
                throw new FormatException("A duplicate key '{0}' was found.".Format(currentKey));
            }
